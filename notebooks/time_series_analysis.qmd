...
Code reads in gas price data and applies inflation correction. Then extracts and writes data for Toronto. 
...
plot_tor_gas = (ggplot(data=df_toronto, mapping=aes(x='year_month', y='cpi_2025')) + 
  geom_line(size=1) + 
  theme_classic())

plot_tor_gas.save("toronto_gas.png")
```
