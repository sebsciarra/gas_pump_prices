...
df_gas = df_gas.query(
    "city == 'Toronto East/Est' & 'Products and product groups' == 'Gasoline'"
)
...
df_gas.query('year_month == "1990-01"')['cpi_2025'] = df_gas.query('year_month == "1990-02"')['cpi_2025']
df_gas.query('year_month == "2025-07"')['cpi_2025'] = df_gas.query('year_month == "2025-06"')['cpi_2025']
...
plot_series(df=df_toronto, 
            id_col='Date', time_col='Date')
```
